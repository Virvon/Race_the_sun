...
namespace Assets.RaceTheSun.Sources.Gameplay.Portals
{
    public class BonusStagePortal : MonoBehaviour
    {
        ...
        [Inject]
        private void Construct(CurrentGenerationStage currentGenerationStage, WorldGenerator.WorldGenerator worldGenerator, ILoadingCurtain transitionCurtain, Sun.Sun sun, Gameplay.Spaceship.Plane plane)
        {
